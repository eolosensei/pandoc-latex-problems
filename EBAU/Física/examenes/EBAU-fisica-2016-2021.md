...
1.  [tags=EBAU20M] Un satélite artificial de telecomunicaciones de \qty{400}{\kg}
...
1.  [tags=EBAU21M] El reventón de un neumático genera en el aire una onda de presión de
    ...
    b.  La onda sonora provocada por la explosión tiene una frecuencia de
        \qty{400}{\Hz} y se propaga en el aire a
...
1.  [tags=EBAU21M] Una onda armónica transversal se propaga en sentido positivo del eje
    $\mathrm{X}$ con una frecuencia de \qty{20}{\Hz}, una velocidad de
    propagación de \qty{10}{\m\per\s}, una amplitud de
...
1.  [tags=EBAU21M] Una lámina de caras planas y paralelas de \qty{5}{\cm} de
    ...
    ![image](img/2021_12_20_b267a32714f88d9113c8g-79.jpg){ width=50% }

1.  [tags=EBAU21M] Se ilumina una lámina de sodio con luz monocromática de
    \qty{500}{\nm}. Sabiendo que el trabajo de extracción del sodio es
    de \qty{2.28}{\eV}. Determinar:
...
------------------------------------------------ ------------------------------------------------------------ ------------------------------------- -----------------------------
 $R_\text{T} = \qty{6370}{\km}$                   $k=\qty{9.0e9}{\N\square\m\per\square\coulomb}$              $m_{\ch{p+}} = \qty{1.7e-27}{\kg}$    $c = \qty{3.0e8}{\m\per\s}$
 $M_\text{T} = \qty{5.97e24}{\kg}$                $|q_{\ch{e^-}}| = |q_{\ch{p+}}| = \qty{1.6e-19}{\coulomb}$   $m_{\ch{e^-}} = \qty{9.1e-31}{\kg}$   $h = \qty{6.6e-34}{\J\s}$
 $G = \qty{6.7e-11}{\N\square\m\per\square\kg}$   $\mu_0 = \qty{4\pi e-7}{\tesla\m\per\A}$                                                                                         
...
------------------------------------------------- ------------------------------------------------- ------------------------------------------- ---------------------------------------
 $G = \qty{6.67e-11}{\N\square\m\per\square\kg}$   $R_\text{T} = \qty{6370}{\km}$                    $M_\text{T} = \qty{5.98e24}{\kg}$           $R_\text{Ío} = \qty{1815}{\km}$                       
 $M_\text{Ío} = \qty{8.94e22}{\kg}$                $K = \qty{9e9}{\N\square\m\per\square\coulomb}$   $\mu_0 = \qty{4\pi e-7}{\N\per\square\A}$   $n_\text{etanol} = 1.36$
 $n_\text{aire} = 1.00$                            $m_{\ch{n^0}} = \qty{1.675e-27}{\kg}$             $h = \qty{6.626e-34}{\J\s}$                 $v_\text{aire} = \qty{340}{\m\per\s}$


1.  [tags=EBAU21O] Se desea ubicar un satélite para comunicaciones, cuya masa es
    $m = \qty{1000}{\kg}$, en una órbita circular \qty{500}{\km} por
...
3.  [tags=EBAU21O] Ío, una de las lunas de Júpiter, posee una intensa actividad
    ...
    alcanzar alturas de \qty{500}{\km} sobre la superficie. Calcule:
...
4.  [tags=EBAU21O] Un dipolo está formado por dos cargas puntuales,
    $q_1=+3 \mathrm{nC}$ y $q_2=-3 \mathrm{nC}$, situadas a una
...
5.  [tags=EBAU21O] Dos hilos conductores rectilíneos paralelos muy largos de longitud L
    ...
    \qty{15000}{\A} se encuentran a una distancia
...
6.  [tags=EBAU21O] Una onda transversal sinusoidal con una amplitud de
    \qty{2.5}{\mm} y una longitud de onda de \qty{1.8}{\m} se
    propaga de izquierda a derecha a lo largo de una cuerda horizontal
    muy larga con una velocidad de \qty{36}{\m\per\s}. Tome
...
6.  [tags=EBAU21O] Se denominan ultrasonidos a las frecuencias por encima del rango auditivo
    ...
    \qty{1500}{\m\per\s} y para una imagen detallada la longitud
    de onda no debe ser superior a \qty{1}{\mm}.

    a.  ¿Qué frecuencia es necesaria? (1 punto)

    Si el rango de frecuencias audibles es \qty{20}{\Hz} a
    \qty{20}{\kHz}:
...
8.  [tags=EBAU21O] Un depósito cúbico que contiene etanol tiene unas paredes planas de
    \qty{2.5}{\cm} de grosor fabricadas con un vidrio transparente
...
9.  [tags=EBAU21O] Colocamos un objeto cuya altura es de \qty{8}{\cm} en un punto
    ...
    ![image](img/2021_12_20_b267a32714f88d9113c8g-81.jpg){ width=50% }
...
![image](img/2021_12_20_b267a32714f88d9113c8g-82.jpg){ width=50% }

1.  [tags=EBAU21X] En el año 2053 una astronauta, cuya masa es $m = \qty{60}{\kg}$, se
...
3.  [tags=EBAU21X] Se colocan en los vértices de un cuadrado de \qty{1}{\m} de lado
    tres masas puntuales de 2,4 y \qty{2}{\kg}, cuyas coordenadas
    son: $(0,1) ;(1,1)$ y $(1,0)$, respectivamente. Calcule:

    a.  La fuerza que ejercerán sobre una partícula de \qty{1}{\g}
...
4.  [tags=EBAU21X] En un punto P que se encuentra a una cierta distancia de una carga
    ...
    campo eléctrico en ese punto es \qty{150}{\N\per\coulomb}.
    Calcule:
...
5.  [tags=EBAU21X] Disponemos de tres hilos conductores rectilíneos paralelos muy
    ...
    hilos consecutivos es $d = \qty{1}{\cm}$.
...
5.  [tags=EBAU21X] La ecuación de una onda transversal
    ...
    b.  Represente la elongación de los puntos de la cuerda para un tramo de
        ...
        $t = \qty{0.5}{\ms}$ y $t = \qty{1}{\ms}$. ( $0.5$ puntos)
...
7.  [tags=EBAU21X] Te encuentras situado a una distancia de \qty{10}{\m} de tu
    ...
    cuya frecuencia es de \qty{850}{\Hz}. La potencia emisora de los
...
9.  [tags=EBAU21X] Responda razonadamente a las siguientes cuestiones:
    ...
    b.  Teniendo en cuenta que la lente correcta debe formar una imagen en
        ...
        \qty{0.25}{\m}. Las distancias referidas se consideran respecto a la
        lente. (1 punto)
...
11. [tags=EBAU21X] Supongamos que se desintegra completamente \qty{1}{\kg} de
    materia. Calcule:
