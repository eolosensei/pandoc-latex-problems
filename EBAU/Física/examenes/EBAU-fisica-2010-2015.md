...
1.  [tags=EBAU10OgB] Un satélite artificial de \qty{900}{\kg} posee una órbita
...
2.  [tags=EBAU10OsA] La longitud de onda umbral para el potasio es \qty{564}{\nm}.
...
1.  [tags=EBAU12XsA] Una partícula de carga eléctrica \qty{20}{\nano\coulomb} y masa
...
4.  [tags=EBAU13XsA] Un haz de luz de frecuencia $f = \qty{4e14}{\Hz}$ se mueve por el agua,
...
3.  [tags=EBAU13XsB] Una carga de \qty{5}{\micro\coulomb} se desplaza con una velocidad
...
4.  [tags=EBAU14OsA] Un protón con una energía cinética de \qty{1}{\eV} se mueve en
...
1.  [tags=EBAU14XgA] Un trozo de chatarra espacial de \qty{25}{\kg} de masa que se
    dirige directo hacia la Tierra, en caída libre, tiene una velocidad
    de \qty{10}{\m\per\s} a una altura sobre la superficie
    terrestre de \qty{300}{\km}. Calcula.
...
2.  [tags=EBAU14XgA] Una partícula de masa $m = \qty{32}{\g}$, unida a un muelle de
    constante elástica $k = \qty{20}{\N\per\m}$, oscila
...
3.  [tags=EBAU14XgA] Dos partículas puntuales de cargas $q_1=3 \mu \mathrm{C}$ y
    $q_2=2 \mu \mathrm{C}$ están situadas respectivamente en los
    puntos de coordenadas $(-a, 0)$ y $(a, 0)$ con $a = \qty{10}{\cm}$.
    ...
    Datos: constante $K = \qty{9e9}{\N\square\m\per\square\coulomb}$.
...
2.  [tags=EBAU14XgB] Una onda armónica se propaga por una cuerda a lo largo del eje $X$
    ...
    \qty{2}{\m\per\s}. Su amplitud es \qty{25}{\cm} y su
...
4.  [tags=EBAU14XgB]
    a.  La energía de una transición electrónica es de \qty{3}{\eV}.
    ...
    b.  Un láser de \qty{30}{\W} de potencia neta emite con una longitud
        de onda de \qty{400}{\nm}. ¿Cuántos fotones emite cada segundo? (1 punto)

    Datos: $h = \qty{6.6e-34}{\J\s}$; $c = \qty{3e8}{\m\per\s}$.
...
1.  [tags=EBAU14XsA] Un satélite tiene una masa $m = \qty{500}{\kg}$ y su órbita,
...
3.  [tags=EBAU14XsA] Una chica grita frente a una montaña y oye el eco de su voz
    ...
    b.  Si la frecuencia de las ondas sonoras es \qty{1}{\kHz} ¿Cuánto
        vale su longitud de onda? (1,25 puntos) Dato: Velocidad de propagación
        del sonido en el aire: \qty{340}{\m\per\s}.
...
4.  [tags=EBAU14XsB] Un chico está realizando las tareas domésticas quitando la ropa del
    ...
    senoidalmente con una frecuencia de \qty{2}{\Hz} y una amplitud
    de \qty{7,5}{\cm}. La rapidez de la onda es
    $v=12 \mathrm{~m} / \mathrm{s}$. En $t = \qty{0}{\s}$ el extremo
...
3.  [tags=EBAU15OsA] Una partícula describe un movimiento armónico simple y sabemos que
    ...
    nula. Si el periodo de este movimiento es de \qty{20}{\s},
    escribe la ecuación de la elongacion (2,5 puntos).

4.  [tags=EBAU15OsA] Considera una carga puntual de \qty{2}{\micro\coulomb} situada en el
...
1.  [tags=EBAU15OsB] En un informe se han presentado las siguientes medidas
    ...
    órbitas circulares. Razona a partir de la 3ª Ley de
...
4.  [tags=EBAU15OsB] En un laboratorio se maneja una muestra de \qty{40}{\mg} del
...
1.  [tags=EBAU15XgA] Determina a qué altura sobre la superficie de la Tierra la
    ...
    Datos: Radio de la Tierra $R = \qty{6370}{\km}$; campo gravitatorio en
...
3.  [tags=EBAU15XgA] Una partícula que se mueve con movimiento armónico simple está en el
    ...
    equilibrio. Si su frecuencia de vibración es \qty{40}{\Hz},
    calcula
...
5.  [tags=EBAU15XgA]
    ...
    b.  Un grupo de estudiantes de Física de segundo de bachillerato ha
        medido en el laboratorio de su centro el tiempo que un péndulo simple de
        \qty{1.30}{\m} de longitud tarda en describir 10 oscilaciones de
        pequeña amplitud. La experiencia se ha repetido cinco veces. Los
        resultados se muestran en la tabla siguiente. Obtén a partir de ellos el
        valor medio de la gravedad en la zona (1,5 puntos).
...
1.  [tags=EBAU15XgB] Una onda armónica se propaga en sentido negativo del eje $X$ con una
    velocidad de \qty{8}{\m\per\s}. Su período es
    \qty{0,5}{\s} y su amplitud es de \qty{0,5}{\m}.
...
5.  [tags=EBAU15XgB]
    a.  Indica qué expresión se utiliza para determinar la intensidad
        ...
        $\mathrm{W} / \mathrm{m}^{2}$ tiene un sonido de \qty{120}{\dB}
        (1 punto).

    b.  Se quiere determinar la velocidad del sonido en el aire haciendo
        experiencias con un diapasón y un tubo largo T, introducido parcialmente
        en agua. La frecuencia del diapasón usado es de \qty{650}{\Hz}. Las
        longitudes de permitidas (armónicos) verifican la expresión:
...
1.  [tags=EBAU15XsA] La aceleración de la gravedad en la superficie de Marte es de 3,7
    ...
    \qty{6.370}{\km} y la masa de Marte es 0,11 veces la de la
    Tierra, calcula:
    ...
    c.  El peso en dicha superficie de una astronauta de \qty{70}{\kg}
...
3.  [tags=EBAU15XsA] Escribe la ecuación de una onda que se propaga de izquierda a
    ...
    \qty{5}{\m\per\s}, una amplitud de \qty{20}{\cm} y
    una frecuencia de \qty{10}{\Hz} (2,5 puntos)
...
5.  [tags=EBAU15XsA]
    a.  Calcula la intensidad del sonido si su nivel de intensidad es de
        \qty{140}{\dB} (umbral de sensación dolorosa) (1 p.). Dato:
...
1.  [tags=EBAU15XsB] Se cuelga una masa de \qty{250}{\g} del extremo de un resorte y
...
4.  [tags=EBAU15XsB] Si se ilumina la superficie de un metal con luz de longitud de onda
    \qty{512}{\nm}, la energía cinética máxima de los electrones
    ...
    mismo metal luz de \qty{365}{\nm} de longitud de onda (1,25 p.).

    Datos: $c=3 \cdot 10^{8} \mathrm{~m} / \mathrm{s}, h = \qty{6.6e-34}{\J\s} .$
